# Let me fix the indentation error and create the complete package files
import os
import json

print("=== CREATING COMPLETE DOWNLOADABLE PACKAGE ===\n")

# 1. Main run.py content (fixed indentation)
...
print("✅ Source code files created")
